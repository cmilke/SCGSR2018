...
\NewPart{Education}{}
    \EducationEntry
        ...
        {\begin{itemize}[itemsep=-3pt]
            ...
            \item[] Cumulative GPA: 3.22 / 4.00 (as of Spring 2015)
        \end{itemize}}
    \sepspace
    ...
    \WorkEntry {SMU Optics Lab Software Development}
        ...
        {\begin{itemize}
            ...
            \item[] Research Position Details:
                Development of a suite of Python-based code able to interface with and perform automated tests using several pieces of National Instruments based hardware interfaced to a custom built FPGA.
        \end{itemize}}
    \sepspace
