...
\NewPart{Research/Work Experience}{}
    \WorkEntry {ATLAS Authorship Project}
        {September 2017 - Present}
        {Southern Methodist University}
        {\begin{itemize}
            \item[] \textbf{Project:}
                Retune ATLAS B-Jet Trigger with FTK Tracks
            \item[] \textbf{Supervisor:}
                Stephen Sekula
            \item[] \textbf{Research Position Details:}
                Alteration and tuning of a boosted decision tree algorithm, known as the ATLAS B-Jet Trigger,
                to include track information from a purpose-built computer array, the FTK (\underline{F}ast \underline{T}rac\underline{k}er).  
        \end{itemize}}
    \sepspace
